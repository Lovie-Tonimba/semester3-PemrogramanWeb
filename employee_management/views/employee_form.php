...
<script>
    ...
    // PENAMBAHAN SCRIPT BARU UNTUK VALIDASI INPUT FORM SALARY SUPAYA BISA JUTAAN
    // Fungsinya: hapus titik (.) saat form dikirim ke server
    document.querySelector('form').addEventListener('submit', function() {
        const salaryInput = document.getElementById('salary');
        // hapus semua titik biar nilainya jadi angka murni, misal "5.000.000" jadi "5000000"
